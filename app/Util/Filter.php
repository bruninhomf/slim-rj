...
/*
 * File        : Filter.php
 * Description : Wrapper de prevenção a SQL Injection
*/
...
class Filter {
    ...
    protected static $blacklist = [
        'select', 'insert', 'delete', 'where', 'drop table',
        'show tables', 'update', '--', '//'
    ];
    ...
    */
    public static function value($value) {
        if(is_string($value)){
            return (!empty($value)) ? self::escape_unicode(
                trim(addslashes(str_ireplace(self::$blacklist, '', (string) $value)))
            ) : null;
        }else{
            return $value;
        }
    ...
    /*
    |--------------------------------------------------------------------------
    | Filtra um array recursivamente
    |--------------------------------------------------------------------------
    */
    public static function array(array $data, $whitelist = []){
        array_walk_recursive($data, function(&$value) use($whitelist){
            $value = (!in_array($value, (array) $whitelist)) ?
    ...
    /*
    |--------------------------------------------------------------------------
    | Remove a formatação de arquivos XML
    |--------------------------------------------------------------------------
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Remove emojis e outros caracteres unicode
    |--------------------------------------------------------------------------
    */
    protected static function escape_unicode($string){
